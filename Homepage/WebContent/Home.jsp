...
<body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="logo" href="Home.jsp"><img src="img/logo.svg" alt="Logo"></a>
        </div>
    ...
    <header>
      <div class="container">
        <div class="row">
          <div class="col-xs-6">
            <a href="Home.jsp"><img src="img/logo.svg" alt="Logo"></a>
          </div>
        ...
        <div class="row header-info">
          <div class="col-sm-10 col-sm-offset-1 text-center">
            <h1 class="wow fadeIn"> CHO Gye-Jin, &nbsp;  PORTFOLIO </h1>
            <br />
            <p class="lead wow fadeIn" data-wow-delay="0.5s"> HTML,JSP,JAVA</p>
            <br />
 <!--              
         <div class="row">
              <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-left wow fadeInUp" data-wow-delay="1.4s">
                    <a href="suvey.jsp" class="btn btn-primary btn-lg">&nbsp; &nbsp; 설문 조사 &nbsp; &nbsp;  </a>
                  </div>
                  </div>
              </div>
            </div>  
  -->
        ...
        <div class="row">
              <div class="col-md-8 col-md-offset-3 col-sm-10 col-sm-offset-1">
                <div class="row">
                  <div class="col-xs-3 text-right wow fadeInUp" data-wow-delay="1s">
                    <a href="#be-the-first" class="btn btn-secondary btn-lg scroll">Learn More</a>
                  </div>
                  <div class="col-xs-3 text-center wow fadeInUp" data-wow-delay="1.4s">
                    <a href="suvey.jsp" class="btn btn-primary btn-lg">&nbsp; &nbsp; 설문 조사 &nbsp; &nbsp;  </a>
                  </div>
                   <div class="col-xs-4 text-left wow fadeInUp" data-wow-delay="1.4s">
                    <a href="suvey.jsp" class="btn btn-warning btn-lg">&nbsp; &nbsp; &nbsp; NEXT &nbsp; &nbsp; &nbsp;  </a>
                  </div>
                  </div>
              </div>
            </div>  
	    ...
	    <div class="container">
		    <div class="row">
			    ...
			    <div class="col-sm-4 wow fadeIn" data-wow-delay="0.8s">
				    <hr  class="line blue">
				    <h3>App Feature two Here</h3>
				    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra orci ut est facilisis, eu elementum mi volutpat. Pellentesque ac tristique nisi.</p>
			    </div>
			    <div class="col-sm-4 wow fadeIn" data-wow-delay="1.2s">
				    <hr  class="line yellow">
				    <h3>App Feature three Here</h3>
				    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra orci ut est facilisis, eu elementum mi volutpat. Pellentesque ac tristique nisi.</p>
			    </div>
		    </div>
	    </div>
